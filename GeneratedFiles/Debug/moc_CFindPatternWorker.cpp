...
QT_MOC_LITERAL(4, 39, 6), // "doWork"
QT_MOC_LITERAL(5, 46, 16), // "FindPatternParam"
QT_MOC_LITERAL(6, 63, 5) // "param"

    },
    "CFindPatternWorker\0resultReady\0\0result\0"
    "doWork\0FindPatternParam\0param"
};
...
void CFindPatternWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->resultReady((*reinterpret_cast< unsigned long long(*)>(_a[1]))); break;
        ...
        {
            typedef void (CFindPatternWorker::*_t)(unsigned long long );
...
// SIGNAL 0
void CFindPatternWorker::resultReady(unsigned long long _t1)
{
